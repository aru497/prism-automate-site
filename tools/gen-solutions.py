...
{json.dumps(ldjson, indent=2)}
  ...
  <style>
    ...
    * {{ box-sizing: border-box; }}
    ...
    .badge {{ display: inline-flex; align-items: center; gap: 0.5rem; margin-top: 1.3rem; padding: 0.4rem 0.95rem; border-radius: 0; font-size: 0.78rem; font-weight: 600; letter-spacing: 0.02em; border: 1px solid transparent; }}
